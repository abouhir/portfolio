...
<table class="table table-striped table-bordered  mt-3 ">
    ...
    <tbody class="text-center table-text-body  scrollbar">
      ...
      <tr>
        ...
        <td class="col-4"  >{{$item->niveau}}</td>
        <td class="col">
            <a href="{{route("langue.edit",$item->id)}}" class="btn btn-outline-warning"> <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="23" height="23" x="0" y="0" viewBox="0 0 477.867 477.867" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g>
            ...
            <form action="{{route("langue.delete",$item->id)}}" method="post"  style="display : inline">
                @csrf
                @method("DELETE")
