...
<div class="container bg-experience scrollbar">
  <div class="col-md-12 ">
<table class="table table-striped table-bordered  mt-3 ">
  ...
  <tbody class="text-center table-text-body  ">
      @foreach ($experiences as $item)
          
     
    <tr>
      <td scope="row">{{$item->titre}}</td>
      <td class="col-4 text-start "><p class="description-show-competence">{{$item->description}}</p></td>
      <td class="col"  >{{$item->date}}</td>
      <td class="col"  >{{$item->lieu}}</td>
      <td class="col">
          <a href="{{route("experience.edit",$item->id)}}" class="btn btn-outline-warning"> <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="23" height="23" x="0" y="0" viewBox="0 0 477.867 477.867" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g>
