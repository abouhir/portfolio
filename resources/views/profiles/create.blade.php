...
<div class="row mt-2">
    <div class="col-12">
    <textarea class="form-control input-form" rows="3" name="adresse" placeholder="Adresse" required></textarea> 
    </div>
</div> 
...
<div class="row mt-2">
    <div class="col-12">
        <input type="tel" class="form-control input-form " name="telephone" placeholder="Telephone" required/> 
    </div>
</div> 
<div class=" row text-danger">
    <div class="col-12">
...
<div class="row mt-2">
    <div class="col-12">
        <input type="text" class="form-control input-form" name="facebook" placeholder="Facebook Url"/> 
    </div>
</div> 
<div class=" row text-danger">
    <div class="col-12">
...
<div class="row mt-2">
    <div class="col-12">
        <input type="text" class="form-control input-form" name="github" placeholder="Github Url"/> 
    </div>
</div> 
<div class=" row text-danger">
    <div class="col-12">
...
<div class="row mt-2">
    <div class="col-12">
        <input type="text" class="form-control input-form " name="linkedin" placeholder="Linkedin Url"/> 
    </div>
</div> 
<div class=" row text-danger">
    <div class="col-12">
