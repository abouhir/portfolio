...
@section('content')
    ...
    <div class="bg-show-competence scrollbar">
      <div class="row">
      @foreach ($competences as $item)
      
      <div class="offset-1 col-3 mt-2 me-0 mb-3">
      <div  class="bg-card card logo-show-competence"  style="height : 400px">
        <img width="200px" height="200px" src="{{asset("storage/competences_logo/".$item->logo)}}" class="card-img-top logo-show-competence" alt="...">
        <div class="card-body">
          <h5 class="card-title titre-show-competence text-center">{{$item->nom}}</h5>
          <p class="card-text description-show-competence">{{$item->description}}</p>
          <div class="row">
            <div class="col">
          <a href="{{route("competence.edit",$item->id)}}" class="col-12 btn btn-outline-warning">
